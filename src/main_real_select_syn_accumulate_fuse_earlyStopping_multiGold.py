...
if __name__ == "__main__":
    ...
    if args.voting_dp_epsilon >= (1E5)-(1E-5):
        ...
        args.voting_dp_sigma = args.function_sensitivity * np.sqrt(2*np.log(1.25/args.voting_dp_delta)) / (args.voting_dp_epsilon * np.sqrt(args.steps*args.gold_party_num))
