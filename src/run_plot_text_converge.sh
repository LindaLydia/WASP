...
for task_name in "${task_list[@]}"; do
    for plm_name in "${plm_list[@]}"; do
        ...
        strings=(
          ...
          "./data_accumulate/votingCLASS_promptCLASS_${folder_type}_top/gold_100_1_0.0_OODgold/${task_name}/${plm_name}_6000/bert-base-uncased/sentence-t5-base/increasedTheta_KD1_FuseDataset1/fewshotK8_15_0.5/0/"
        )
        logging_strings=(
          ...
          "./logging/multiGold_eval_on_real/with_real_few_shot_accumulate_votingCLASS_promptCLASS_${folder_type}_top/gold_100_1_0.0_OODgold/bert-base-uncased/sentence-t5-base/0.9_errorOnlyWrongOnlySelf_Adjust_increasedTheta_Entropy_KD1_FuseDataset1/0_1_init1200_steps4_unbalance_temp1.0/fewshotK8_15_0.5/${task_name}/${plm_name}_6000/log_data_accumulate_4.89894920704081_0.txt"
        )
        result_strings=(
