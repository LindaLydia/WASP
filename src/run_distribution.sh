...
for task_name in "${task_list[@]}"; do
    ...
    for i in $(seq 0 $((${#strings[@]}-1))); do
        ...
        # python plotting/plot_embedding_distribution.py --small_model_name sentence-t5-base --syn_data_path $syn_data_path --llms gpt2-xl llama-2-7b-chat-hf vicuna-7b-1.5v opt-6.7b chatglm3-6b-base flan-t5-xl --task_name $task_name --num_use_samples_inner 1000 1000 1000 1000 1000 1000 --logging_path=$logging_path --gpu 0 --steps 4 --small_model_name bert-base-uncased --consider_real True --gold_data_num 100

        # python plotting/plot_embedding_distribution.py --small_model_name sentence-t5-base --syn_data_path $syn_data_path --llms gpt2-xl --task_name $task_name --num_use_samples_inner 6000 --logging_path=$logging_path --gpu 0 --steps 4 --small_model_name bert-base-uncased --consider_real True --gold_data_num 100
        python plotting/plot_embedding_distribution.py --small_model_name sentence-t5-base --syn_data_path $syn_data_path --llms opt-6.7b --task_name $task_name --num_use_samples_inner 6000 --logging_path=$logging_path --gpu 0 --steps 4 --small_model_name bert-base-uncased --consider_real True --gold_data_num 100
        python plotting/plot_embedding_distribution.py --small_model_name sentence-t5-base --syn_data_path $syn_data_path --llms vicuna-7b-1.5v --task_name $task_name --num_use_samples_inner 6000 --logging_path=$logging_path --gpu 0 --steps 4 --small_model_name bert-base-uncased --consider_real True --gold_data_num 100
